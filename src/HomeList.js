		...
		return(
            <View style={styles.container}>
            	 <FlatList 
                  ...
                  renderItem={ ({item})=> <Lista data={item} navigation={this.props.navigation} /> } // criar o component Lista // cria o navigation para ser acessado no component Lista
               />
            </View>    
...
class Lista extends Component{  // esse component pode ser criado em um arquivo externo e só dar um import
   constructor(props){
    super(props);
    this.state = {};
   ...
   clicou(){
     this.props.navigation.navigate('HomeProduts',{products:this.props.data.products, title:this.props.data.title} ); // parametros passados: produtos e titulo do menu
   }
